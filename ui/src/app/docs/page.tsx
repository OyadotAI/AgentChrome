          ...
          <Table
            ...
            rows={[
              [
                ...
                <a key="mac" href="/downloads/Oya.Browser-1.0.48-universal.dmg" className="text-accent hover:text-accent-hover transition-colors">Oya Browser.dmg</a>,
              ],
              [
                'Linux (arm64)',
                <a key="linux" href="/downloads/Oya.Browser-1.0.48-x64.AppImage" className="text-accent hover:text-accent-hover transition-colors">Oya Browser.AppImage</a>,
              ],
            ]}
          />
          <p className="mb-3 text-[15px] leading-relaxed">
